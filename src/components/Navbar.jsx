  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-screen-xl mx-auto px-4 text-white">
      ...
      <ul
        className={
          showNav
            ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-night-black ease-in-out duration-500"
            : "fixed left-[-100%]"
        }
      >
        <h1 className="w-full text-3xl font-bold text-caribbean-green m-4">
          REACT.
        </h1>
